...
# 或者在 Python 脚本中设置（永久生效）
import os
os.environ['TORCH_HOME'] = r'E:\yolo_run\huggingface_cache'
os.environ['HF_HOME'] = r'E:\yolo_run\torch_cache'
...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/custom.yaml", help="dataset.yaml path")   #yolov5s.pt
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / r"E:\StudyInformation\Eat\habit\lung16_dec\yolo\yolov5-master\runs\train\exp2\weights\best.pt", help="model path(s)")  #E:\StudyInformation\Eat\habit\lung16_dec\yolo\yolov5-master\runs\train\exp2\weights\best.pt
